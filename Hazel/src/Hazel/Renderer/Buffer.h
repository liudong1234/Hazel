...
namespace Hazel
{
    ...
    public:
        ...
        inline std::vector<BufferElement> GetElements() const { return this->m_Elements; }
        ...
        std::vector<BufferElement>::const_iterator Begin() const { return this->m_Elements.begin(); }
        std::vector<BufferElement>::const_iterator End() const { return this->m_Elements.end(); }
